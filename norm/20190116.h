...
#define DRAWSCENE_FN	0x0043FBE0
#define RENDERER_PTR	*reinterpret_cast<DWORD*>(0x00DC86F8)
...
#define SESSION_DATA                      	\
	...
	/* +0x14B8 */ BYTE offset11[0x6160];	\
	/* +0x7618 */ char c_name[40];
//};

#define GETTALKTYPE_FN				0x00A226F0
#define RECALCAVERAGEPINGTIME_FN	0x00A35130
#define SESSION_PTR					0x01039358

//
// CUIWindowMgr defines
//
#define UIWINDOWMGR_MAKEWINDOW_FN 0x00723F90
#define UIWINDOWMGR_PTR 0x00E95398
...
// sub types
// CUIBookWnd
#define UIBOOKWND_SENDMSG_FN 0x006253C0
